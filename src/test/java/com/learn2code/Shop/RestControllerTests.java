...
public class RestControllerTests {
    ...
    public void product() throws Exception{
        ...
        Product product = new Product(merchant.getId(),"Klavesnice","Mega levna klavesnice",1, 10);
        ...
        // Get product
        String returnProduct = mockMvc.perform(get("/product/" + product.getId())
                .contentType((MediaType.APPLICATION_JSON)))
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();

        Product productFromRest = objectMapper.readValue(returnProduct, Product.class);
        ...
        String returnUpdatedProduct = mockMvc.perform(get("/product/" + product.getId())
                        .contentType((MediaType.APPLICATION_JSON)))
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();

        Product updatedProduct = objectMapper.readValue(returnUpdatedProduct, Product.class);
    ...
    public void Customer() throws Exception{
        Customer customer = new Customer("Ferko","Mrkvicka","xxx","xxx", 23, "xxx");

        // Add customer
        String id = mockMvc.perform(post("/customer/add")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        Customer returnedCustomer = objectMapper.readValue(customerJson, customer.getClass());
